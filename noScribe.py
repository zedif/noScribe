...
try:
    cfg.whisper.vad_threshold = float(app_config['voice_activity_detection_threshold'])
except:
    app_config['voice_activity_detection_threshold'] = '0.5'
    cfg.whisper.vad_threshold = 0.5
...
cfg.whisper.diarization_file = cfg.pyannote.output
            ...
            try:
                ...
                if self.speaker_detection != 'none':
                    try:
                        ...
                        # load diarization results and write segments to log file
